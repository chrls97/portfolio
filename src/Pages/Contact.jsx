...
const Contact = () => {
  ...
  return (
     <section id="contact"  className='w-full relative px-[5%] py-[20px] sm:py-[80px]'>
      <div className='flex flex-col justify-center items-center max-w-[1520px] mx-auto'>
        ...
        <div className='flex flex-col sm:flex-row gap-5 mt-5'>
          ...
          <hr className='border-[0.5px] border-gray-500  h-auto' data-aos="fade-up" data-aos-duration="1500"/>
